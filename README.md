...
While testing this, a few caveats have arisen which need to be detailed upfront, as they can lead to issues when PM2 is installed as a service:
  - The published version of this package currently wants your global `pm2` install to be version `0.15.10` - a fix for this issue is in the works, but it's awaiting thorough testing.
